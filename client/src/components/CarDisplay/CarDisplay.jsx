...
const CarDisplay = ({ car }) => {
  ...
  return (
    <div className="carDisplay" data-aos="fade-down" data-aos-duration="800">
      <Link className="card" to={`/cars/${car._id}`}>
        <div className="carDisplay-header" data-aos="fade-right" data-aos-duration="1500">
          <img className="carDisplay-image" src={car.image} alt={car.model} />
        </div>
        <div className="carDisplay-column" data-aos="fade-down" data-aos-duration="800">
